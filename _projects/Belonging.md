...
<br>
<div style="display: flex; align-items: center; justify-content: center; gap: 24px; margin-bottom: 16px;">
  <img src="{{ site.url }}{{ site.baseurl }}/assets/img/projects/belonging/Logo_Laval_Virtual.png" alt="LAVAL VIRTUAL" style="width:120px; height:auto;">
  <span style="font-size: 1em; font-weight: extra-thin;transparent; background-clip: text; text-fill-color: transparent;">Showcased in Art Exhibition 2024</span>
</div>
<br>
