...
<div class="ai-tools-explored">
  ...
  <div class="ai-tools-explored-card">
    <div class="card-link-icon"><i class="fas fa-external-link-alt"></i></div>
    <a class="ai-tools-explored-slot1" href="https://leonardo.ai/" target="_blank">Leonardo AI </a>
    <span class="tags">Text-to-Image</span>
    <a class="ai-tools-explored-slot3" href="#" target="_blank" >Explorations by Zoha <i class="fas fa-link"></i></a>
  </div>
