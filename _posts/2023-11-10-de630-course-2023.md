...
.project-authors {
  ...
  .ai-tools-explored-card:hover .card-link-icon {
    display: flex;
    justify-content: center;
    align-items: center;
  }
  .ai-tools-explored .tags {
    padding: 8px 16px;
...
<div class="ai-tools-explored">
  ...
  <div onclick="window.open('https://leonardo.ai', '_blank');"
  class="ai-tools-explored-card">
    <div class="card-link-icon"><i class="fas fa-external-link-alt"></i></div>
    <h3 class="ai-tools-explored-slot1">Leonardo AI</h3>
    <span class="tags">Text-to-Image</span>
    <a class="ai-tools-explored-slot3" onclick="event.stopPropagation();" href="https://drive.google.com/drive/u/1/folders/1ndK_Cxm-qEiACbZ0C0lsFGJBcL_uPDq5" target="_blank" >Explorations by Zoha <i class="fas fa-link"></i></a>
  </div>
...
{%- comment -%} <script>
    var aiToolsExploredCard = document.getElementsByClassName("ai-tools-explored-card")[0];
    aiToolsExploredCard.addEventListener("click", function() {
