...
header:
  teaser: /assets/img/updates/course/icon_ai_in_design.jpg
categories: course
...
{% include de630-final-project.html
  topic="Mimesis - Generative artworks with chatGPT"
...
{% include de630-ai-tools-explored-card.html
   ...
   %}
{% include de630-ai-tools-explored-card.html
    toolName="Stable diffusion (parseq)"
