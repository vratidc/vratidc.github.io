...
export class WebXRButton {
  ...
  constructor(options) {
    ...
    options.color = options.color || 'rgb(0,128,85)';
    options.background = options.background || false;
    options.disabledOpacity = options.disabledOpacity || 0.3;
    ...
    options.textEnterXRTitle = options.textEnterXRTitle || 'View image in Stereo VR';
    options.textXRNotFoundTitle = options.textXRNotFoundTitle || 'Stereo VR unavailable';
    options.textExitXRTitle = options.textExitXRTitle || 'Exit Stereo VR';
